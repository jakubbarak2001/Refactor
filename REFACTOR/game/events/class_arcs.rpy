...
label re_bb_trainer_intro:
    ...
    menu:
        "TAKE THE OFFER — Train private. [[+1 SOMA, -10 Hatred, arc continues]]":
            ...
            show screen outcome_panel("+1 SOMA, -10 PCR HATRED  ·  [[ARC: TRAINER OPENED]]")
            pause
...
label re_de_kovar_eyes:
    ...
    menu:
        "READ HIM CAREFULLY — Profile. [[arc continues, +5 Coding]]":
            ...
            show screen outcome_panel("+5 CODING SKILL, [[KOVÁŘ PROFILE +1]]  ·  [[ARC OPENED]]")
            pause
            hide screen outcome_panel
...
label re_de_kovar_warning:
    ...
    menu:
        "DEFER — 'I'm listening, Lieutenant.' [[arc continues, profile deepens]]":
            ...
            show screen outcome_panel("-5 PCR HATRED, [[KOVÁŘ PROFILE +2]]  ·  [[STAGE 3 INCOMING]]")
            pause
            hide screen outcome_panel
...
label re_de_kovar_choice:
    ...
    menu:
        "DELETE THE REPORT — Square the deal. [[+25,000 CZK, +20 Hatred — arc closes dark]]":
            ...
            show screen outcome_panel("+25,000 CZK, +20 PCR HATRED. [[COMPLICIT]]")
            pause
            hide screen outcome_panel
...
label re_bh_telegram_meet:
    ...
    menu:
        "GO — Show up. [[arc continues, +5 Coding]]":
            ...
            show screen outcome_panel("+5 CODING. [[ARC OPENED — sample acquired]]")
            pause
            hide screen outcome_panel
...
label re_bh_sketchy_lab:
    ...
    menu:
        "TAKE A VIAL — One sample. Document everything. [[+15 Coding, +10 Hatred]]":
            ...
            show screen outcome_panel("+15 CODING, +10 PCR HATRED. [[VIAL ACQUIRED]]")
            pause
            hide screen outcome_panel
        ...
        "ASK INSTEAD — 'Show me the synthesis. Teach me.' [[+25 Coding, no compound]]":
            ...
            show screen outcome_panel("+25 CODING. [[SYNTHESIS LEARNED — no contraband on you]]")
            pause
            hide screen outcome_panel
...
label re_bh_test_subject:
    ...
    menu:
        "AGREE — Become the trial. [[+30 Coding, +25 Hatred, dependency risk]]":
            ...
            show screen outcome_panel("+30 CODING, +25 PCR HATRED. [[DEPENDENCY ACTIVATED]]")
            pause
            hide screen outcome_panel
        ...
        "COUNTER — 'I'll do it. Triple my fee. Cash. Anonymous.' [[risk: 50/50]]":
            python:
                ...
                if _bh_roll <= 50:
                    ...
                    _bh_out = "+40,000 CZK, +20 CODING, +20 PCR HATRED. [[PAID TRIAL]]"
                else:
                    stats.increment_stats_pcr_hatred(15)
